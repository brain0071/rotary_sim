...
class MPC:
    ...
    def __init__(self, robot, kinematics_n_nodes, kinematics_q_cost, kinematics_r_cost, kinematics_dt, dynamics_n_nodes, 
                       dynamics_q_cost, dynamics_r_cost, dynamics_dt):
        

        self.robot = robot
        self.kinematics_opt = MPC_Kinematics_Optimizer(robot, kinematics_n_nodes, kinematics_q_cost, kinematics_r_cost, kinematics_dt)
        self.dynamics_opt = MPC_Dynamics_Optimizer(robot, dynamics_n_nodes, dynamics_q_cost, dynamics_r_cost, dynamics_dt)
